...
def deploy():
    ...
    with SCPClient(ssh.get_transport()) as scp:
        ...
        # 2025-12-25 Michael Whisper Assets
        if os.path.exists('static/js/michael_whisper.js'):
            scp.put('static/js/michael_whisper.js', f'{REMOTE_BASE}/static/js/michael_whisper.js')
            print("✓ static/js/michael_whisper.js")
        if os.path.exists('static/css/michael_whisper.css'):
             scp.put('static/css/michael_whisper.css', f'{REMOTE_BASE}/static/css/michael_whisper.css')
             print("✓ static/css/michael_whisper.css")
        if os.path.exists('templates/base.html'):
             scp.put('templates/base.html', f'{REMOTE_BASE}/templates/base.html')
